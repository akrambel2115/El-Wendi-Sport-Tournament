  ...
  const TournamentBracketDisplay = () => {
    ...
    return (
      <>
        ...
        >
          {/* Background elements with logo and memorial text */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
            {/* Multi-layered gradient background */}
            <div className="absolute inset-0 bg-gradient-to-r from-green-50 via-blue-50 to-purple-50 opacity-85"></div>
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-yellow-50 to-transparent opacity-60"></div>
            
            {/* Logo and memorial text watermark - further increased from opacity-15 to opacity-20 */}
            <div className="absolute inset-0 flex flex-col items-center justify-center opacity-20 pointer-events-none">
              ...
              <div className="text-3xl font-bold text-gray-700 text-center">
                إحياء ذكرى المرحوم بشاشحية أحسن
              </div>
            </div>

            {/* Stadium field markings - increased opacity values further */}
            <div className="absolute top-1/2 left-1/2 w-[800px] h-[500px] -translate-x-1/2 -translate-y-1/2 
                           border-[3px] border-green-200 rounded-[50%] opacity-30"></div>
            <div className="absolute top-1/2 left-1/2 w-[700px] h-[400px] -translate-x-1/2 -translate-y-1/2
                           border-[2px] border-green-200 rounded-[50%] opacity-40"></div>
            <div className="absolute top-1/2 left-1/2 w-[200px] h-[200px] -translate-x-1/2 -translate-y-1/2
                           border-[2px] border-green-300 rounded-full opacity-40"></div>
            
            {/* Center line - increased from opacity-25 to opacity-30 */}
            <div className="absolute inset-y-0 left-1/2 border-l-2 border-dashed border-green-200 -translate-x-1/2 opacity-30"></div>
            <div className="absolute inset-x-0 top-1/2 border-t-2 border-dashed border-green-200 -translate-y-1/2 opacity-30"></div>
            
            {/* Goal areas on left and right - increased from opacity-35 to opacity-40 */}
            <div className="absolute top-1/2 left-0 w-[80px] h-[150px] -translate-y-1/2 border-r-2 border-y-2 border-green-300 opacity-40"></div>
            <div className="absolute top-1/2 right-0 w-[80px] h-[150px] -translate-y-1/2 border-l-2 border-y-2 border-green-300 opacity-40"></div>
            
            {/* Soccer balls scattered around - increased opacity values further */}
            <div className="absolute top-[8%] left-[7%] w-8 h-8 opacity-40 animate-pulse" style={{ animationDuration: '6s' }}>
            ...
            <div className="absolute bottom-[15%] right-[9%] w-10 h-10 opacity-50 animate-bounce" style={{ animationDuration: '8s' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="#444" d="M177.1 228.6L207.9 320h96.5l29.62-91.38L256 172.1L177.1 228.6zM255.1 0C255.1 0 255.1 0 255.1 0C255.1 0 255.1 0 255.1 0C114.6 0 .0001 114.6 .0001 256S114.6 512 256 512s255.1-114.6 255.1-255.1S397.4 0 255.1 0zM416.6 360.9l-85.4-1.297l-25.15 81.59C290.1 445.5 273.4 448 256 448s-34.09-2.523-50.09-6.859l-25.15-81.59l-85.4 1.297C75.15 335.9 62.94 308.5 56.62 279.4l53.95-64.97l-40.93-78.21C86.58 98.19 121.7 69.4 162.3 54.1l71.51 50.24L305.3 54.1c40.58 14.48 75.73 43.19 92.66 81.26l-40.93 78.21l53.95 64.97C404.1 308.5 391.9 335.9 371.7 360.9H416.6z"/>
              </svg>
            </div>
            <div className="absolute top-[30%] right-[25%] w-12 h-12 opacity-30 animate-spin" style={{ animationDuration: '15s' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="#444" d="M177.1 228.6L207.9 320h96.5l29.62-91.38L256 172.1L177.1 228.6zM255.1 0C255.1 0 255.1 0 255.1 0C255.1 0 255.1 0 255.1 0C114.6 0 .0001 114.6 .0001 256S114.6 512 256 512s255.1-114.6 255.1-255.1S397.4 0 255.1 0zM416.6 360.9l-85.4-1.297l-25.15 81.59C290.1 445.5 273.4 448 256 448s-34.09-2.523-50.09-6.859l-25.15-81.59l-85.4 1.297C75.15 335.9 62.94 308.5 56.62 279.4l53.95-64.97l-40.93-78.21C86.58 98.19 121.7 69.4 162.3 54.1l71.51 50.24L305.3 54.1c40.58 14.48 75.73 43.19 92.66 81.26l-40.93 78.21l53.95 64.97C404.1 308.5 391.9 335.9 371.7 360.9H416.6z"/>
              </svg>
            </div>
            <div className="absolute top-[70%] left-[20%] w-6 h-6 opacity-60 animate-pulse" style={{ animationDuration: '4s' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="#444" d="M177.1 228.6L207.9 320h96.5l29.62-91.38L256 172.1L177.1 228.6zM255.1 0C255.1 0 255.1 0 255.1 0C255.1 0 255.1 0 255.1 0C114.6 0 .0001 114.6 .0001 256S114.6 512 256 512s255.1-114.6 255.1-255.1S397.4 0 255.1 0zM416.6 360.9l-85.4-1.297l-25.15 81.59C290.1 445.5 273.4 448 256 448s-34.09-2.523-50.09-6.859l-25.15-81.59l-85.4 1.297C75.15 335.9 62.94 308.5 56.62 279.4l53.95-64.97l-40.93-78.21C86.58 98.19 121.7 69.4 162.3 54.1l71.51 50.24L305.3 54.1c40.58 14.48 75.73 43.19 92.66 81.26l-40.93 78.21l53.95 64.97C404.1 308.5 391.9 335.9 371.7 360.9H416.6z"/>
              </svg>
            </div>
            <div className="absolute top-[15%] left-[40%] w-5 h-5 opacity-40 animate-bounce" style={{ animationDuration: '7s' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="#444" d="M177.1 228.6L207.9 320h96.5l29.62-91.38L256 172.1L177.1 228.6zM255.1 0C255.1 0 255.1 0 255.1 0C255.1 0 255.1 0 255.1 0C114.6 0 .0001 114.6 .0001 256S114.6 512 256 512s255.1-114.6 255.1-255.1S397.4 0 255.1 0zM416.6 360.9l-85.4-1.297l-25.15 81.59C290.1 445.5 273.4 448 256 448s-34.09-2.523-50.09-6.859l-25.15-81.59l-85.4 1.297C75.15 335.9 62.94 308.5 56.62 279.4l53.95-64.97l-40.93-78.21C86.58 98.19 121.7 69.4 162.3 54.1l71.51 50.24L305.3 54.1c40.58 14.48 75.73 43.19 92.66 81.26l-40.93 78.21l53.95 64.97C404.1 308.5 391.9 335.9 371.7 360.9H416.6z"/>
              </svg>
            </div>
            
            {/* Trophy icons - increased opacity values */}
            <div className="absolute top-[10%] right-[15%] w-16 h-16 opacity-25 rotate-12">
            ...
            <div className="absolute top-[60%] left-[12%] w-12 h-12 opacity-20 -rotate-12">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                <path fill="gold" d="M552 64H448V24c0-13.3-10.7-24-24-24H152c-13.3 0-24 10.7-24 24v40H24C10.7 64 0 74.7 0 88v56c0 66.5 77.9 131.7 171.9 142.4C203.3 338.5 240 360 240 360v72h-48c-35.3 0-64 20.7-64 56v12c0 6.6 5.4 12 12 12h296c6.6 0 12-5.4 12-12v-12c0-35.3-28.7-56-64-56h-48v-72s36.7-21.5 68.1-73.6C498.4 275.6 576 210.3 576 144V88c0-13.3-10.7-24-24-24zM64 144v-16h64.2c1 32.6 5.8 61.2 12.8 86.2-47.5-16.4-77-49.9-77-70.2zm448 0c0 20.2-29.4 53.8-77 70.2 7-25 11.8-53.6 12.8-86.2H512v16z"/>
              </svg>
            </div>
            
            {/* Football jerseys - increased to opacity-30 */}
            <div className="absolute bottom-[10%] left-[8%] w-14 h-14 opacity-30">
            ...
            <div className="absolute top-[12%] left-[75%] w-16 h-16 opacity-25 rotate-12">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                <path fill="#ef4444" d="M211.8 0c7.8 0 14.3 5.7 16.7 13.2C240.8 51.9 277.1 80 320 80s79.2-28.1 91.5-66.8C413.9 5.7 420.4 0 428.2 0h12.6c22.5 0 44.2 7.9 61.5 22.3L628.5 127.4c6.6 5.5 10.7 13.5 11.4 22.1s-2.1 17.1-7.8 23.6l-56 64c-11.4 13.1-31.2 14.6-44.6 3.5L480 197.7V448c0 35.3-28.7 64-64 64H224c-35.3 0-64-28.7-64-64V197.7l-51.5 42.9c-13.3 11.1-33.1 9.6-44.6-3.5l-56-64c-5.7-6.5-8.5-15-7.8-23.6s4.8-16.6 11.4-22.1L137.7 22.3C155 7.9 176.7 0 199.2 0h12.6z"/>
              </svg>
            </div>
            
            {/* Referee whistle - increased to opacity-30 */}
            <div className="absolute top-[65%] right-[15%] w-12 h-12 opacity-30">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            ...
            {/* Football boots/shoes - increased to opacity-30 */}
            <div className="absolute bottom-[20%] left-[20%] w-16 h-16 opacity-30 -rotate-12">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            ...
            {/* Football stadium - increased to opacity-20 */}
            <div className="absolute top-[5%] left-[40%] w-24 h-24 opacity-20">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            ...
            {/* Football goal - increased to opacity-25 */}
            <div className="absolute bottom-[12%] right-[20%] w-16 h-16 opacity-25">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            ...
            {/* Colorful ribbon confetti - increased opacity values */}
            <div className="absolute top-[10%] left-[10%] w-40 h-40 opacity-20 rotate-45 animate-pulse" style={{ animationDuration: '12s' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            ...
            <div className="absolute bottom-[15%] right-[10%] w-40 h-40 opacity-20 -rotate-45 animate-pulse" style={{ animationDuration: '10s' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            ...
            {/* Tournament text watermark enriched - increased from opacity-[0.08] to opacity-[0.12] */}
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 whitespace-nowrap text-[130px] font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-200 via-green-100 to-purple-100 opacity-[0.12] text-center leading-none">
              البطولة
              <div className="text-[60px] opacity-70 font-semibold">الوندى 2024</div>
            </div>
            
            {/* Curved lines and other background elements - increased opacity */}
            <div className="absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-blue-200 to-transparent opacity-30"></div>
            <div className="absolute top-[40%] left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-purple-200 to-transparent opacity-25"></div>
            <div className="absolute top-[60%] left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-green-200 to-transparent opacity-25"></div>
            
            {/* Sporty geometric shapes - increased opacity values */}
            <div className="absolute top-[40%] right-[5%] w-24 h-24 opacity-20 bg-gradient-to-br from-blue-200 to-transparent rounded-full blur-sm"></div>
            <div className="absolute top-[20%] left-[8%] w-16 h-16 opacity-25 bg-gradient-to-tr from-purple-200 to-transparent rounded-full blur-sm"></div>
            <div className="absolute bottom-[10%] left-[50%] w-32 h-32 opacity-20 bg-gradient-to-tl from-green-200 to-transparent rounded-full blur-md"></div>
            
            {/* Dynamic light rays - increased from opacity-35 to opacity-40 */}
            <div className="absolute inset-0 bg-gradient-to-b from-blue-50/10 via-transparent to-blue-50/10 opacity-40"></div>
          </div>
